...
export class MenuController {
  ...
  public static RefreshMenu(menuList: Menu[], menuItemList: MenuItem[]) {
    let menu: INavData[] = [];
    ...
    menuList.forEach(item => {
      ...
      MenuController.NavItems.push(navItem);
  ...
  public static GetNavItems(userName: string) {
    ...
    return MenuController.NavItems;
  }

  public static NavItems: INavData[] = [];

  private static AdminMenu() {
    MenuController.NavItems = [
      {
        name: 'Dashboard',
        url: '/Base/...',
    ...
    console.log('** : ',MenuController.NavItems);
  }
